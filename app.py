    ...
    if request.method == "POST":
        ...
        with connect_db() as conn:
            ...
            """,
                (
                    machine_r_series,
                    machine_j_series_7200,
                    machine_m_series,
                    machine_j_series_6135,
                    machine_j_series_6110,
                    machine_m_series_4040,
                    machine_series_4730_4830,
                    user_id,
                ),
            )
            conn.commit()
...
def dashboard():
    ...
    if True:
        ...
        try:
            ...
            maintenance_tasks = (
                "Não foi possível gerar as tarefas de manutenção para hoje."
            )
